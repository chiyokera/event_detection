...
from tdeed.dataset.datasets import get_datasets
from tdeed.dataset.frame import ActionSpotVideoDataset
...
from tdeed.util.eval import evaluate, evaluate_SNB, valMAP_SN

# Local imports
from tdeed.util.io import load_json, load_text, store_json
...
def update_args(args, config):
    ...
    args.frame_dir = "../../../data/sample/frames"
    args.save_dir = "../../../data/sample/results"
...
def main(args):
    ...
    wandb.init(
        ...
        project="ExtendTDEED-First-Train-nonPretrained-FromThis",
    ...
    pretrain_classes = load_text(
        os.path.join("data", "soccernet", "class.txt")
    )  # Get pretrain classes
