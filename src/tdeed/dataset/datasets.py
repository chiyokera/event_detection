...
def get_datasets(args):
    ...
    train_data = ActionSpotDataset(
        classes,
        os.path.join("data", args.dataset, "train.json"),  # Match List
        args.frame_dir,
        args.store_dir,
        args.store_mode,
        args.modality,
    ...
    if args.pretrain != None:
        ...
        dataset_pretrain_kwargs = {
            "stride": stride_pretrain,
            "overlap": overlap_pretrain,
            "radi_displacement": args.radi_displacement,
            "mixup": args.mixup,
            "dataset": args.pretrain["dataset"],
        }

        pretrain_classes = load_classes(
            os.path.join("data", args.pretrain["dataset"], "class.txt")
        )
